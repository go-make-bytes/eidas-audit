module github.com/go-make-bytes/eidas-audit
...
// nats.go (+ nkeys/nuid) come in indirectly via go-platform-kit/broker/natsbroker.
// Run `go mod tidy` on a dev machine to populate the indirect require block and go.sum.
